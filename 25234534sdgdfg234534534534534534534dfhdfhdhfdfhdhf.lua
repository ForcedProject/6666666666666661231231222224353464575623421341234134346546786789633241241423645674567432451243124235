...
Main.Position = UDim2.new(0.00262906542, 0, 0.010050253, 0)
Main.Size = UDim2.new(0.095539555, 0, 0.0532663316, 0)
Main.ZIndex = 5
...
local function JUXZ_fake_script() -- Toggle.LocalScript 
...
coroutine.wrap(JUXZ_fake_script)()
local function TGEVUB_fake_script() -- Farm.LocalScript 
...
coroutine.wrap(TGEVUB_fake_script)()
local function QHUK_fake_script() -- Lift.LocalScript 
...
coroutine.wrap(QHUK_fake_script)()
local function LDWN_fake_script() -- Reb.LocalScript 
...
coroutine.wrap(LDWN_fake_script)()
local function MTJRYNR_fake_script() -- Tp.LocalScript 
...
coroutine.wrap(MTJRYNR_fake_script)()
local function TBUGMZ_fake_script() -- Reset.LocalScript 
...
coroutine.wrap(TBUGMZ_fake_script)()
local function LUXKE_fake_script() -- Anti.LocalScript 
...
coroutine.wrap(LUXKE_fake_script)()
