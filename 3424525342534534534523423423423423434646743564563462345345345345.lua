...
Main.Position = UDim2.new(0.00262906356, 0, 0.010050253, 0)
...
local function QGHDYV_fake_script() -- Toggle.LocalScript 
...
coroutine.wrap(QGHDYV_fake_script)()
local function RSNH_fake_script() -- Sell.LocalScript 
...
coroutine.wrap(RSNH_fake_script)()
local function JCWEN_fake_script() -- Buy.LocalScript 
...
coroutine.wrap(JCWEN_fake_script)()
local function HHVR_fake_script() -- Upgrade.LocalScript 
...
coroutine.wrap(HHVR_fake_script)()
local function MNOT_fake_script() -- Auto.LocalScript 
...
coroutine.wrap(MNOT_fake_script)()
local function HXUHWS_fake_script() -- Reb.LocalScript 
...
coroutine.wrap(HXUHWS_fake_script)()
local function JCTWU_fake_script() -- Anti.LocalScript 
...
coroutine.wrap(JCTWU_fake_script)()
